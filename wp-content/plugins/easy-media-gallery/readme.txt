...
Tags: admin, album, albums, best gallery, best gallery plugin, best plugin gallery, slider, best portfolio, facebook, filterable gallery, foto, fotoalbum, free gallery plugin, fotogalerie, free gallery, free photo gallery, free slider, gallery watermark, galeri, galeria, galerie, galery, galleria, galleries, gallery, plugin, gallery image, gallery plugin, gallery slider, gallery wordpress, google, google maps, grid, grid gallery, image, image album, image gallery, image rotator, image slider, images, images gallery, lightbox, lightbox gallery, media library, media, media gallery, pictures, photo, photo album, photo albums, photo gallery, photoalbum, photographer, photography, photogallery, photos, photoset, picture, plugin gallery, portfolio, post, posts, responsive, responsive gallery, seo, shortcode gallery, slide, slideshow, twitter, video gallery, website gallery, widget, wordpress gallery, google street view, wordpress seo, wp gallery, thumbnail gallery
...
Create responsive image gallery, photo albums, image slider and image Carousel just in minutes

== Description ==
**Gallery** - **Photo Albums** - **Portfolio** plugin satisfy all your needs to create different types of media such as image gallery, photo albums, portfolio and also from a simple picture to an image slider or image lightbox, image carousel a video and audio (html5) gallery. This **gallery** plugin represents a perfect solution for any type of media. Each item can be:
...
* video - YouTube and Vimeo Thumbnail (<em>[learn more here](http://www.youtube.com/watch?v=uAGWUcs5ofE "video gallery")</em>)
* Embed from Reverbnation or Soundcloud (<em>[Pro Version](http://goo.gl/ckecFP "audio plugin")</em>)
* Audio player (<em>HTML5 player for Pro version and Flash player for Lite version</em>)
...
> * [Gallery with Default Lightbox ( Light, dark transparent skins )](http://ghozylab.com/plugins/easy-media-gallery-pro/demo/best-gallery-lightboxes/emg-lightbox-default/ "gallery with EMG Lightbox")
...
Just create Multiple Image ( Slider ) media type , insert an images and save your media, after that put the gallery using Easy Media Shortcode Generator and your gallery will ready just in minutes. **NO NEED to RE-UPLOAD** all your images, **NO NEED to SET ANY FOLDER PERMISSION**. You can choose and insert an images that already uploaded in Wordpress media library. Upgrade to pro version to be able to create gallery with pagination, gallery with filter and gallery with more than 10 lightbox styles.

= Image Albums /  Photo Albums = 

You can create up to 3 albums with Lite Version ( <em>max 15 images per album</em> ). You have to upgrade to Pro Version if you want to create unlimited albums and images. Another Pro Version features are album with filter, album with ajax mode, album with more than 10 lightbox styles.
...
In Pro version you can create Image Carousel easily. We will add this feature in lite version for the next release. We also already create [Image Carousel](https://wordpress.org/plugins/image-carousel/ "Image Carousel Plugin") plugin.

= Video Gallery =

This plugin allows you to embed and displaying videos using lightbox overlay. You can embed video from Youtube, Vimeo and MP4. We provide HTML5 player in Pro Version and Flash player for lite version. 

= Audio Gallery =

Also, this plugin allows you to embed audio. You can embed mp3 audio format easily. In Pro Version you can easily embed audio from Soundcloud and Reverbnation.
...
* More than 10 lightboxes for your gallery or photo albums  [See Example](http://ghozylab.com/plugins/easy-media-gallery-pro/demo/best-gallery-lightboxes/ "Lightbox Gallery")
