...
<div class="metabox-holder" style="max-width:73%; display:block;">
			<div class="postbox">
				<h3><?php _e( 'Just Like, Share or Subscribe and Get Free Updates', 'easmedia' ); ?></h3>
...
<div class="fb-like" data-href="http://ghozylab.com/plugins/easy-media-gallery-pro/demo/best-gallery-and-photo-albums-demo/" data-layout="box_count" data-action="like" data-show-faces="false" data-share="false"></div>
    </div>
                
        <div id="easymedia_docs3" style="margin-right:10px; padding:10px !important; display:inline-block;">
<div class="fb-share-button" data-href="http://ghozylab.com/plugins/easy-media-gallery-pro/demo/best-gallery-grid-galleries-plugin/" data-layout="box_count"></div>
    </div>
